...
function tarjetasBloqueadas(){
    //Vamos hacer un recorrido por las 12 tarjetas y cuando se haga el recorrido bloqueamos cada una de ellas
...
function descubrir(id){
    ...
    if(tarjetasDescubiertas == 1){
        //Se muestra el primer numero y asociamos los 12 botones con los 12 elementos del array desordenado
        ...
        //Se muestra el segundo numero y asociamos los 12 botones con los 12 elementos del array desordenado
        ...
        if(primerNumero == segundoNumero){
            ...
            //Si el jugador ha acertado las 6 pares de tarjetas, es decir si ha levantado correctamente las 12 tarjetas
